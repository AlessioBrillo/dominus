...
export async function upPg(db: DatabaseProvider): Promise<void> {
  ...
  await execPg(db, 'CREATE INDEX IF NOT EXISTS idx_api_keys_tenant ON api_keys(tenant_id)');
  await execPg(db, 'CREATE UNIQUE INDEX IF NOT EXISTS idx_api_keys_prefix ON api_keys(key_prefix)');
}
